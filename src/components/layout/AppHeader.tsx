...
import { LogOut, Menu, Bell, MessageSquare, CheckCheck, Send, AlertTriangle } from 'lucide-react';
...
export const AppHeader: React.FC<AppHeaderProps> = ({ onToggleSidebar, onNavigate }) => {
  ...
  return (
    <header className="sticky top-0 z-40 bg-white/85 dark:bg-[#070B14]/85 backdrop-blur-xl border-b border-slate-200/80 dark:border-white/10 px-3 sm:px-6 py-2.5 sm:py-3 transition-colors duration-300 shadow-2xs">
      <div className="max-w-7xl mx-auto flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <div className="flex items-center gap-2.5 sm:gap-3">
            <div className="relative">
              <img src="/crest.svg" alt="Everest Crest" className="w-8 h-10 sm:w-9 sm:h-11 object-contain drop-shadow-xs" />
            ...
            <div>
              <div className="font-serif-title font-bold text-slate-950 dark:text-white text-xs sm:text-base tracking-wide flex items-center gap-1.5 leading-tight">
                EVEREST <span className="text-amber-600 dark:text-cyan-400 font-sans text-xs sm:text-sm font-semibold tracking-normal">INTERNATIONAL</span>
              </div>
              <div className="text-[9px] sm:text-[10px] text-slate-500 dark:text-slate-400 tracking-wider font-semibold uppercase hidden xs:block">
        ...
        <div className="flex items-center gap-1.5 sm:gap-3">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 pl-2 border-l border-slate-200/80 dark:border-white/10">
            {user.avatarUrl ? (
              <img
                src={user.avatarUrl}
                alt={user.name}
            ...
            <button
              ...
              className="p-2 rounded-xl text-slate-400 hover:text-rose-600 hover:bg-rose-50 dark:hover:bg-rose-950/30 transition-colors touch-target flex items-center justify-center cursor-pointer"
            >
