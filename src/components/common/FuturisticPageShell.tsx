        ...
        <div className="rounded-[calc(1.5rem-0.25rem)] bg-white/95 dark:bg-[#0E1526]/90 backdrop-blur-xl border border-slate-200/80 dark:border-white/5 p-4 sm:p-6 transition-colors duration-300">
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
            ...
            <div className="flex items-start sm:items-center gap-3.5">
              <div className="w-11 h-11 sm:w-12 sm:h-12 rounded-2xl bg-gradient-to-br from-amber-500/20 via-indigo-500/10 to-cyan-500/20 dark:from-indigo-500/30 dark:to-cyan-500/30 border border-amber-500/30 dark:border-cyan-500/30 flex items-center justify-center text-amber-700 dark:text-cyan-300 shrink-0 shadow-xs">
              ...
              <div>
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  {badgeText && (
                    <span
                      className={clsx(
                        'px-2.5 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider border shadow-2xs inline-flex items-center gap-1',
                        getBadgeStyle()
                      )}
                    >
