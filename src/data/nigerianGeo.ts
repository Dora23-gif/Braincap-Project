// Comprehensive dataset of Nigerian 36 States + FCT and their Local Government Areas (LGAs)
...
export const NIGERIAN_STATES: StateGeoData[] = [
  {
    state: "Abia",
  ...
  {
    state: "Ogun",
    lgas: ["Abeokuta North", "Abeokuta South", "Ado-Odo/Ota", "Ewekoro", "Ifo", "Ijebu East", "Ijebu North", "Ijebu North East", "Ijebu Ode", "Ikenne", "Ilugun Alaro", "Imeko Afon", "Ipokia", "Obafemi Owode", "Odeda", "Odogbolu", "Ogun Waterside", "Remo North", "Shagamu", "Yewa North", "Yewa South"]
  },
  {
    state: "Ondo",
...
export function getLgasForState(stateName: string): string[] {
  const found = NIGERIAN_STATES.find(s => s.state.toLowerCase() === stateName.toLowerCase());
